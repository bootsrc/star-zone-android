...
public class CommentBox extends FrameLayout {
    ...
    public void showCommentBox(@NonNull long momentid, @Nullable IComment commentInfo) {
        ...
        //对于同一条动态恢复草稿，否则不恢复
        if (momentid == this.momentid && StringUtil.noEmpty(draftString)) {
     ...
     */
    public void toggleCommentBox(long momentid, @Nullable IComment commentInfo, boolean clearDraft) {
        if (isShowing) {
