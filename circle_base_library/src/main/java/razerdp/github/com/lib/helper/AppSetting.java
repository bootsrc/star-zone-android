...
import razerdp.github.com.lib.constant.StorageConstant;
...
public class AppSetting {
    ...
    public static long getUserId() {
        SharedPreferences sp = AppContext.getAppContext().getSharedPreferences(StorageConstant.SHARED_PREFERENCES_NAME_PASSPORT, 0);
